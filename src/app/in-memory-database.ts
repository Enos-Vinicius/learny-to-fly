...
export class InMemoryDataBase implements InMemoryDbService {
    ...
    createDb() {
        return {
            minCards: [
                {id: 1, icon: "sun-line", title: "Clareza", background: "green_clarity", selected: true},
                {id: 2, icon: "target",   title: "Objetividade", background: "green_objectivity", selected: false},
                {id: 3, icon: "heart",    title: "Compreensão", background: "green_understanding", selected: false},
            ],
            ...
            contentCards: [
                ...
                {id: 2, icon: "world", title: "What Your Most Vivid Memories Say About You", subtitle: "Even when we believe that we’ve created a happy, ideal life for…"},
